...
fig3_wage_gap <- ggplot(gap_data, aes(x = exp_bin, y = wage_gap, color = gender_lab, fill = gender_lab)) +
...
ggsave("output/figures/Fig3_wage_gap_trend.png", plot = fig3_wage_gap, width = 10, height = 7, dpi = 300)

cat("Biểu đồ xu hướng Wage Gap đã được lưu tại: output/figures/Fig3_wage_gap_trend.png\n")